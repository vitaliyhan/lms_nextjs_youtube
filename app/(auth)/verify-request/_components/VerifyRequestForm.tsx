        ...
        <Card className='w-full mx-auto'>
            ...
            <CardContent className='space-y-6'>
                <div className='flex flex-col items-center space-y-2'>
                    ...
                    <p className='text-sm text-muted-foreground'>Enter your 6-digit code sent to your email</p>
                </div>

                <Button onClick={verifyOtp} disabled={emailPending || !isOtpComplete} className='w-full'>
                    {emailPending ? (
                        <>
